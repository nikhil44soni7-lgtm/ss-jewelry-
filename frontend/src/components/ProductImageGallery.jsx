        ...
        <div className="flex flex-row gap-3 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-800 justify-center w-full shrink-0">
          {safeImages.map((img, idx) => (
            <button
              ...
              className={`relative h-16 w-16 rounded-xl overflow-hidden border-2 bg-white dark:bg-slate-900 transition-all flex items-center justify-center focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none ${
                activeIndex === idx
